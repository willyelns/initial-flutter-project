...
class LoginSignUpWidgets {
  ...
  static Widget showPrimaryButton({
    ...
    return Padding(
      ...
      child: MaterialButton(
        elevation: 5.0,
        shape: RoundedRectangleBorder(borderRadius:BorderRadius.circular(16.0) ), // Adding Border to any widget
        minWidth: 180.0,
        height: 32.0,
        color: Colors.pink,
        child: isLoading ? _showLoading() : _primaryButtonLabel(formMode: formMode),
  ...
  static Widget _secondaryButtonLabel({@required FormMode formMode}) {
    TextStyle textStyle = new TextStyle(fontSize: 18.0, fontWeight: FontWeight.w300);
    String textLabel = formMode == FormMode.LOGIN ? 'Create an Account' : 'Have an Account? Sign in';
